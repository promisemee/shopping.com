	...
	class Login_Controller extends Controller{
				...
				if (isset($_POST['password'])){
					...
					if ($result>0){
						...
						echo "<script type='text/javascript'>
							...
							window.location.href='/mall/index.php'
							</script>";
					} 
					else{
						echo "<script type='text/javascript'>
						window.alert('Wrong Username or Password');
						window.location.href='/mall/member/login.php'
						</script>";
		...
		public function newUser(){
			...
			if ($this->getEmail($email)){
				...
				echo "window.location.href='/mall/index.php'";
				echo "</script>";
			}
		...
		public function myUser(){
            ...
            require_once $_SERVER["DOCUMENT_ROOT"]."/mall/view/userUpload.php";
		...
		public function modifyUser(){
            ...
            if (isset($_SESSION['uid'])){
                ...
                echo 'window.location.replace("/mall/index.php")';
                echo '</script>';
		...
		public function memberCart(){
			...
			require_once $_SERVER["DOCUMENT_ROOT"]."/mall/view/header.php";
			require_once $_SERVER["DOCUMENT_ROOT"]."/mall/view/cart.php";
			require_once $_SERVER["DOCUMENT_ROOT"]."/mall/view/footer.php";
		}
			...
			if (!isset($_SESSION))	session_start();
				if (isset($_POST["action"])){
					if(isset($_POST["ca_id"])){
						...
						$t	= $this->model->getTotal()->fetch();
						$total = $t['sum(p_price * c_quantity)'];
		    			require_once $_SERVER["DOCUMENT_ROOT"]."/mall/view/cartlist.php";
					}
	    		}
