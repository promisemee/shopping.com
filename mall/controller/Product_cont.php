<?php
	...
	class Product_Controller extends Controller{
		...
		public function productList(){
			...
			require_once $_SERVER["DOCUMENT_ROOT"]."/mall/view/product_list.php";
    	...
    	public function reloadList(){
    		...
    		require_once $_SERVER["DOCUMENT_ROOT"]."/mall/view/album.php";
    	}
    	...
    	public function productView(){
    		...
    		if (!$product) {	//such product does not exist
    			require_once $_SERVER["DOCUMENT_ROOT"]."/mall/view/404.php";
    			exit;
    		}
    		...
    		require_once $_SERVER["DOCUMENT_ROOT"]."/mall/view/header.php";
			require_once $_SERVER["DOCUMENT_ROOT"]."/mall/view/product_detail.php";
			require_once $_SERVER["DOCUMENT_ROOT"]."/mall/view/footer.php";
		}
		...
		public function addProduct(){
			...
			if (!isset($_SESSION['user'])||($_SESSION['user']!='Admin')){
				require_once $_SERVER["DOCUMENT_ROOT"]."/mall/view/403.php";
				exit;
			}
            $pid = NULL;
            $pname = NULL;
            ...
            require_once $_SERVER["DOCUMENT_ROOT"]."/mall/view/header.php";
            require_once $_SERVER["DOCUMENT_ROOT"]."/mall/view/product_upload.php";
            require_once $_SERVER["DOCUMENT_ROOT"]."/mall/view/footer.php";
        ...
        public function checkProduct(){
            ...
            if (!empty($_POST)){
                if (isset($_POST['p_name'])){
                    ...
                    try{    //upload image
                        $target_dir = $_SERVER["DOCUMENT_ROOT"]."/mall/public/img/".$_POST['p_category']."/";
                        ...
                        if ($uploadOk == 0) {
                            ...
                            if (move_uploaded_file($_FILES["p_image"]["tmp_name"], $target_file)) {
                                ...
                                window.location.href='/mall/product/addProduct.php'
                                </script>";
		...
		public function modifyProduct(){
            ...
            if (isset($_REQUEST['pid'])){
    			...
    			if (!isset($_SESSION['user'])||($_SESSION['user']!='Admin')){
                    ...
                    $pimg=NULL;
                    $action = "/mall/product/update_Product.php";
            ...
            if (!isset($_SESSION))  session_start();
                if (!empty($_POST)){
                    if (isset($_POST['p_name'])){
                        ...
                        echo 'window.location.replace("/mall/product/viewProduct.php?productNo='.$_SESSION['p_id'].'")';
                        echo '</script>';
