				...
				<div class="wrapper row">
					<div class="preview col-md-6">
						...
						<div class="preview-pic tab-content">
						  	<?php 
		            		$image_src = "/public/img/{$product['p_category']}/{$product['p_id']}.jpg";
		        			?>
							...
							<?php $id = $product['p_id']; $cat = "'".$product['p_category']."'";?>
				  				<div class="row">
				 					<div class="col-md-12 text-center">
				  						<button class="btn btn-dark btn-block cbutton" onclick="location.href='/product/modifyProduct.php?pid='+<?php echo $id?>">
							   				Modify Product
				  						</button>
				 					</div>
				 				</div>
